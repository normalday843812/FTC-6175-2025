 ...
 *
 * <p>These arrays allow you to explicitly shape the curve the robot follows when driving to key
 * poses. Each entry is {@code {x, y, headingDeg}} in Pedro coordinates. Leave an array empty to
 * fall back to the default midpoint control point so existing behavior is unchanged.</p>
 */
@Configurable
