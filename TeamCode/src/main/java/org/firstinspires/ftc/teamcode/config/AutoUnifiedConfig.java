...
public class AutoUnifiedConfig {
    ...
    public static double AUTO_SHOOT_EMPTY_PRECHECK_S = 0.3;
    ...
    public static double TELEOP_FEED_DWELL_S = 0.5;  // Time to push ball into bucket before indexing
    public static double TELEOP_FRONT_SEAT_DWELL_S = 0.3; // wait after slot-0 sensors first see ball before spindexing
    ...
    public static double TELEOP_SPINDEX_VERIFY_DELAY_S = 0.3;
    public static double TELEOP_SPINDEX_JIGGLE_DELTA = 0.06;
    public static double TELEOP_SPINDEX_JIGGLE_DWELL_S = 0.2;
