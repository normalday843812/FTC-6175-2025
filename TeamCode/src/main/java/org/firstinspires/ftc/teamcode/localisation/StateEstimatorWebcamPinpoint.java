...
public class StateEstimatorWebcamPinpoint {
    OpMode opmode;
    ...
    // Constructor
    public StateEstimatorWebcamPinpoint(OpMode opmode, GoBildaPinpointDriver pinpoint, AprilTagLocalizer aprilTagLocalizer) {
        this.opmode = opmode;
