...
public class Constants {
    public static FollowerConstants followerConstants = new FollowerConstants()
            .mass(ROBOT_MASS)
            .forwardZeroPowerAcceleration(-48.186)
            .lateralZeroPowerAcceleration(-99.791)
            .translationalPIDFCoefficients(new PIDFCoefficients(0.06, 0, 0.01, 0.021))
            ...
            .secondaryTranslationalPIDFCoefficients(new PIDFCoefficients(0.06, 0, 0.02, 0.07))
